...
const CREDENTIAL_SERVER_URL =
  "https://panorama-credential-server-ind8d68x4-primezones-projects.vercel.app";
const API_SECRET =
  "nuqf5CT6dXSLLcVD3NpVGZV3c6TvCg9jN7VwmflxJMJQTIPSAXvblENy2An3FXMZ";
      ...
      res.on("end", () => {
        ...
        try {
          if (res.statusCode === 200) {
            ...
            console.log(
              "Supabase URL:",
              credentials.supabase?.url || "Not found",
            );
