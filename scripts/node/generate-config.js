...
function showHelp() {
  console.log(
    "Usage: node generate-config.js --project <projectId> [--projects-path <path>]",
  );
  ...
  console.log(
    "  --projects-path <path>     Custom projects directory path (optional)",
  );
  console.log("  --help, -h                Show this help message");
  console.log("\nExample:");
  console.log(
    "  node generate-config.js --project toyota --projects-path /custom/projects",
  );
}
