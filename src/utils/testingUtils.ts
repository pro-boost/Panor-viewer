...
export class PerformanceTester {
  ...
  getAverageTime(label: string): number {
    ...
    console.log(
      `📊 Performance: Average time for ${label}: ${average.toFixed(2)}ms`,
    );
  ...
  static testHookIntegration(hooks: {
    ...
    if (hooks.sceneManager) {
      console.log("✅ Scene Manager Hook:", {
        hasCalculateDistance:
          typeof hooks.sceneManager.calculateSceneDistance === "function",
    ...
    if (hooks.hotspotManager) {
      console.log("✅ Hotspot Manager Hook:", {
        hasClearHotspots:
          typeof hooks.hotspotManager.clearHotspotsForScene === "function",
        hasCreateHotspots:
          typeof hooks.hotspotManager.createHotspotsForScene === "function",
        hasToggleHotspots:
          typeof hooks.hotspotManager.toggleHotspots === "function",
      });
    }
    ...
    if (hooks.performanceManager) {
      console.log("✅ Performance Manager Hook:", {
        hasPreloadAdjacent:
          typeof hooks.performanceManager.preloadAdjacentScenes === "function",
        hasOptimize:
          typeof hooks.performanceManager.optimizePerformance === "function",
        hasUnloadDistant:
          typeof hooks.performanceManager.unloadDistantScenes === "function",
      });
    }
    ...
    if (hooks.navigation) {
      console.log("✅ Navigation Hook:", {
        hasNavigateToProject:
          typeof hooks.navigation.navigateToProject === "function",
        hasNavigateToScene:
          typeof hooks.navigation.navigateToScene === "function",
        hasGetCurrentProject:
          typeof hooks.navigation.getCurrentProject === "function",
      });
    }
  }
}
    ...
    try {
      ...
      if (gl) {
        console.log("🎮 WebGL Information:", {
          ...
          maxViewportDims: (gl as WebGLRenderingContext).getParameter(
            (gl as WebGLRenderingContext).MAX_VIEWPORT_DIMS,
          ),
        });
      } else {
