  ...
  try {
    switch (method) {
      ...
      case 'POST':
        ...
        const newProjectPath = path.join(process.env.PROJECTS_PATH || path.join(process.cwd(), 'public'), sanitizedName);
      ...
      case 'DELETE':
        ...
        const projectToDelete = path.join(process.env.PROJECTS_PATH || path.join(process.cwd(), 'public'), projectId);
