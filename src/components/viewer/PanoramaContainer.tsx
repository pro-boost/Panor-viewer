...
const PanoramaContainer: React.FC<PanoramaContainerProps> = React.memo(
  function PanoramaContainer({ panoRef, onPanoClick }) {
    return (
      <>
        <div
          ref={panoRef}
  ...
  (prevProps, nextProps) => {
    ...
    return (
      prevProps.panoRef === nextProps.panoRef &&
      prevProps.onPanoClick === nextProps.onPanoClick
    );
  },
);
